...
vk::RenderPass vkInit::create_debug_renderpass(vk::Device logicalDevice, vk::Format swapchainImageFormat, vk::Format depthFormat)
{
	...
	attachment[0].format = swapchainImageFormat;
