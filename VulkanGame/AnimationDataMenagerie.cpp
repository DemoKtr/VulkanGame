#include "AnimationDataMenagerie.h"
#include "Memory.h"

AnimationDataMenagerie::AnimationDataMenagerie()
{
	indexOffset = 0;
}
...
void AnimationDataMenagerie::consume(meshTypes meshType, std::vector<vkMesh::Vertex> data, std::vector<uint32_t> indicies)
{
...
void AnimationDataMenagerie::finalize(FinalizationChunk finalizationChunk)
{
