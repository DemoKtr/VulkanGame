...
namespace vkGbuffer {
	...
	void make_descrip1tor_set(vk::Device logicalDevice, vk::DescriptorSet descriptorSet, vk::DescriptorPool descriptorPool, vk::DescriptorSetLayout layout, vkUtil::GbufferAttachments gbuffer);
}