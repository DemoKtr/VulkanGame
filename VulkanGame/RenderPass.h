...
namespace vkInit {
	...
	vk::RenderPass create_combinedImage_renderpass(vk::Device logicalDevice, vk::AttachmentLoadOp loadtype, vk::ImageLayout initialLayout);
	...
	vk::RenderPass create_debug_renderpass(vk::Device logicalDevice, vk::Format swapchainImageFormat, vk::Format depthFormat);
}
